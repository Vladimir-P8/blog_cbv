...
from mptt.models import MPTTModel, TreeForeignKey # Используется для класса с вложенностью Category
from apps.services.utils import unique_slugify
from taggit.managers import TaggableManager # Добавление функциональности тегирования
from ckeditor.fields import RichTextField # Для редактора WYSIWYG
...
class Post(models.Model):
    ...
    custom = PostManager() # пользовательский кастомный менеджер
...
class Comment(MPTTModel):
    ...
    parent = TreeForeignKey(to='self', verbose_name='Родительский комментарий', null=True, blank=True, related_name='children', on_delete=models.CASCADE)
